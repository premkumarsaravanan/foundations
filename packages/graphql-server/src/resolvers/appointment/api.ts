...
export const callGetAppointmentsAPI = async (args: GetAppointmentsArgs, context: ServerContext) => {
...
export const callGetAppointmentByIdAPI = async (args: GetAppointmentByIdArgs, context: ServerContext) => {
  const traceId = context.traceId
...
export const callCreateAppointmentByAPI = async (args: CreateAppointmentArgs, context: ServerContext) => {
  const traceId = context.traceId
